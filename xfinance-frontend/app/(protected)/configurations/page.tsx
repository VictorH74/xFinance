    ...
    <main className="min-h-screen bg-zinc-50 px-6 py-8 text-zinc-950">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      className="mt-1 h-4 w-4 border-zinc-300 text-zinc-950 focus:ring-zinc-400 rounded-xs"
                    />
                    <span>
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm space-y-2">
          ...
          <p className="text-sm text-zinc-400">
            Exclua sua conta permanentemente caso nao queira mais usar a
            plataforma.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-4 rounded-xl border border-red-200 bg-red-50 p-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-red-600">
                Esta acao remove seus dados, historico e configuracoes de forma
                permanente.
              </p>
            </div>
            <button
