...
const EnvSchema = z.object({
  DATABASE_URL: z.string({
    error: "Variável de ambiente 'DATABASE_URL' não encontrado!",
  }),
  JWT_ACCESS_SECRET: z.string({
    error: "Variável de ambiente 'JWT_ACCESS_SECRET' não encontrado!",
  }),
  JWT_REFRESH_SECRET: z.string({
    error: "Variável de ambiente 'JWT_REFRESH_SECRET' não encontrado!",
  }),
